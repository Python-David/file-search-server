...
# from kmp_search import kmp_search, search_string_in_file
# from linear_search import read_file_contents
...
#         exists = search_string_in_file(request, reread_on_query)
...
#     """
#
#     # Initialize the matcher with the file path and reread_on_query flag
#     initialize_matcher(file_path, reread_on_query)
#
#     try:
...
#     #     print("caching string in start server")
#
#     try:
#         while True:
#             try:
