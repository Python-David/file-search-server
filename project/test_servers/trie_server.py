...
# from trie_search import Trie, build_trie_from_file, search_string_in_file
...
#
#         if reread_on_query:
#             # Rebuild Trie for each query
#             trie = Trie()
#             with open(file_path, "r") as file:
#                 for line in file:
#                     trie.insert(line.strip())
#             exists = trie.search(request)
#         else:
#             # Use the cached Trie
#             exists = search_string_in_file(
#                 file_path, request
...
#         build_trie_from_file(file_path)
#
#     try:
#         while True:
#             try:
